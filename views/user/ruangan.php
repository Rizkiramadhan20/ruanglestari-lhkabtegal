    ...
    <div class="fixed bottom-20 md:bottom-10 flex flex-col gap-4 md:right-5 right-4 z-50">
        ...
        <div class="z-50">
            ...
            <button onclick="window.accessibilityManager.toggleMenu()" title="Aksesibilitas"
                class="bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 p-4">
