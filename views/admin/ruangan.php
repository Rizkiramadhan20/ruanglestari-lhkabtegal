            ...
            <div class="flex w-full h-max min-h-screen ml-0 md:ml-[270px] flex flex-col bg-gray-100">
                ...
                <div class="w-full h-full flex flex-col gap-10 px-7 py-7">
                    ...
                    <div class="w-full h-full flex flex-col gap-6">
                        <!-- Perbaikan: search & tambah ruangan jadi responsif -->
                        <div class="w-full h-max flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                            <form method="GET" class="flex items-center w-full md:w-auto">
                                <input type="text" name="search"
                                    class="h-10 w-full md:w-42 rounded placeholder:font-light text-sm border indent-3 focus:outline-[#3E5879]"
                                    placeholder="Search..."
                            ...
                            <a href="tambah-ruangan.php"
                                class="px-4 h-10 bg-[#3E5879] hover:opacity-80 flex items-center justify-center text-sm text-white rounded w-full md:w-auto">
                                Tambah Ruangan
                            </a>
                        </div>

                        <!-- Perbaikan: tabel punya scroll horizontal sendiri -->
                        <div class="relative overflow-x-auto overflow-y-auto max-h-[500px] border rounded-lg">
                            <table class="min-w-full text-sm text-left text-blue-500 shadow-md rounded-lg styled-table">
                                <thead class="text-xs text-white uppercase bg-[#3E5879] ">
                                    <tr>
                                        <th scope="col" class="px-6 py-3">No</th>
                                        <th scope="col" class="px-6 py-3">Nama</th>
                                        <th scope="col" class="px-6 py-3">Description</th>
                                        <th scope="col" class="px-6 py-3">Fasilitas-Meja&Kursi</th>
                                ...
                                <tbody>
                                    ...
                                    <tr
                                        ...
                                        <td class="px-6 py-4"><?php echo htmlspecialchars($ruangan['description']); ?>
                                        </td>
                                        <td class="px-6 py-4"><?php echo htmlspecialchars($ruangan['amenities']); ?>
                                        </td>
                                        <td class="px-6 py-4 flex flex-wrap items-center gap-2">
                                            <a href="edit-ruangan.php?id=<?php echo $ruangan['id']; ?>"
                                                class="text-green-500">Edit</a> |
                                            <a href="hapus_ruangan.php?id=<?php echo $ruangan['id']; ?>"
                                                class="text-red-500"
